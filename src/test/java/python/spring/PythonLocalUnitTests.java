...
@ActiveProfiles({Profiles.INTEGRATION_TEST, Profiles.LOCAL})
@SpringApplicationConfiguration(classes = {SpringRootConfig.class, SpringJacksonConfig.class, SpringMailConfig.class, SpringSecurityConfig.class, SpringWebConfig.class, SpringDataConfig.class, PersistenceContext.class, PythonLocalUnitTests.class})
@ComponentScan(basePackageClasses = SetupDataLoader.class)
@WebAppConfiguration
@IntegrationTest
@EnableAutoConfiguration
public class PythonLocalUnitTests extends PythonUnitTests {
